...
public class HomePage extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        startLocation = (Button)view.findViewById(R.id.location);
        ...
        Button startLocation = (Button)view.findViewById(R.id.location);
    ...
    class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            BitmapDescriptor bitmapDescriptor = BitmapDescriptorFactory.fromResource(R.drawable.ic_location_red);
            //创建一个图层选项
